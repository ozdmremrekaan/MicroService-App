...
namespace Mango.Services.OrderAPI.Controllers
{
    ...
    public class OrderAPIController : ControllerBase
    {
        ...
        [Authorize]
        [HttpGet("GetOrders")]
        public async Task<ResponseDto> CreateOrder(string? userId = "")
        {
            try
            {
        ...
        public async Task<ResponseDto> CreateOrder(int id)
        {
            try
            {
        ...
        public async Task<ResponseDto> UpdateOrderStatus([FromBody] string newStatus, int orderId)
        {
            try
            {
